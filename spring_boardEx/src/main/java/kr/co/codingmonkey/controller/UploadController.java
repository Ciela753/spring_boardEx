...
public class UploadController {
	...
	public void upoadFormPost(MultipartFile[] uploadFile, Model model) {
	...
	public @ResponseBody String deleteFile(String fileName, Boolean image) {
		...
		if(image) new File(uploadFolder, new AttachFileDTO(fileName).getThumb()).delete();
		return "delete";
	}
	...
	public ResponseEntity<Resource> download(String fileName, @RequestHeader("User-Agent") String userAgent) throws UnsupportedEncodingException {
		...
		try {
			...
			headers.add("Content-Disposition", "attachmant; fileName="+downloadName);
